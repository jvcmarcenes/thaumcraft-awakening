...
import io.github.jvcmarcenes.tca.items.Thaumonomicon;
...
public class ModItems {
  ...
  public static final RegistryObject<Thaumonomicon> THAUMONOMICON = register("thaumonomicon", Thaumonomicon::new, def(1));
  ...
  public static final RegistryObject<JarBlockItem> ESSENTIA_JAR = register("essentia_jar", p -> new JarBlockItem(ModBlocks.JAR.get(), p), def(16));
